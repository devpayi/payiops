...
- ล้างข้อมูลทดสอบ: Apps Script → เลือกฟังก์ชัน `clearTestData` → Run (ลบแถวในแท็บ requests/groups/processed_events เก็บหัวตาราง)
...
- ผูกได้ 1 กลุ่ม (กลุ่มแรกที่แท็กหลังล้างข้อมูล) กลุ่มอื่นแท็กแล้วบอทตอบว่ายังไม่เปิดใช้งาน ถ้าจะเปลี่ยนกลุ่ม รัน `clearTestData` แล้วแท็กในกลุ่มใหม่ ถ้าจะใช้หลายร้านต้องทำชีต+สคริปต์แยก
